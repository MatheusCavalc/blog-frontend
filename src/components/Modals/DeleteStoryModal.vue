...
import { deleteStory } from '@/services/functions'

const props = defineProps(['modalActive', 'story_id'])
...
<template>
    <div class="fixed overflow-x-hidden overflow-y-auto inset-0 flex justify-center items-center z-50"
        ...
        <div class="relative mx-auto w-2/5">
            <div class="bg-white w-full rounded-md pt-8 pb-10 px-8">
                ...
                <div class="mt-6">
                    <p class="text-2xl text-center font-bold tracking-tight">Delete story</p>

                    <p>Deletion is not reversible, and the story will be completely deleted. If you do not want to delete,
                        you can unlist the story.</p>
                </div>

                <div class="flex flex-row-reverse mt-10">
                    <template v-if="!isButtonDisabled">
                        <button :disabled="isButtonDisabled" @click="destroyStory()"
