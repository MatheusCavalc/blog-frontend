...
const props = defineProps(['modalActive', 'user_username'])
const emit = defineEmits(['closeModal', 'reloadPage'])

let username = ref(props.user_username)
        ...
        <div class="relative mx-auto w-2/5">
            <div class="bg-white w-full rounded-md pt-8 pb-10 px-8">
                <div class="flex justify-between">
                    <p class="text-2xl font-bold tracking-tight">Username and subdomain</p>

                    <button class="" @click="closeModal">X</button>
                </div>

                <div class="mt-6">
                    <p class="text-gray-600 mb-2">Username</p>
