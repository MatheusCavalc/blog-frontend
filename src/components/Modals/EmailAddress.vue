...
const props = defineProps(['modalActive', 'user_email'])
const emit = defineEmits(['closeModal', 'reloadPage'])

let email = ref(props.user_email)
        ...
        <div class="relative mx-auto w-2/5">
            <div class="bg-white w-full rounded-md pt-8 pb-10 px-8">
                <div class="flex justify-between">
                    <p class="text-2xl font-bold tracking-tight">Email address</p>
                ...
                <div class="mt-6">
                    ...
                    <p class="text-sm text-gray-600 mt-1">You can sign into Medium with this email address.</p>
                </div>
